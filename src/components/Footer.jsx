  ...
  return (
    <div className="flex flex-col gap-[2rem]">
        ...
        <div className="container mx-auto mt-[5rem] py-[5rem] px-[7rem] max-w-[1300px]">
          <div className="flex justify-between gap-[3rem]">
            <div className="w-[40%]  flex flex-col gap-[3rem]">
              ...
              <p className="flex items-center gap-[1rem] text-greyFooterColor">
                <img
              ...
              <p className="flex flex-col gap-[1rem]">
                <span className="text-[1.8rem] text-greyFooterColor">
              ...
              <div className="flex flex-col gap-[2rem]">
                ...
                <nav>
                  <ul className="flex flex-col gap-[1rem]">
                    <li className="text-[1.6rem] text-greyFooterColor px-[2rem] py-[1rem] hover:rounded-[2.4rem] hover:bg-greyLight">
            ...
            <div className="w-[30%] flex flex-col gap-[3rem]">
              ...
              <p className="text-[1.6rem] text-greyFooterColor">
                برای اطلاع از جدیدترین تور های مهرپرواز ایمیل خود را وارد کنید
              </p>
              <form className="w-full flex justify-between">
                <input
                  className="w-[75%] p-[1rem]  text-[1.4rem] rounded-[3.2rem] border-2 border-borderPrimaryColor focus:border-pink"
                  type="text"
                  placeholder="آدرس ایمیل خود را وارد کنید"
                />
                <button
                  type="submit"
                  className="text-white px-[2rem] py-[1rem] text-[1.6rem] bg-redPrimary rounded-[3.2rem] hover:bg-redSecondary"
                >
                  ارسال
                </button>
              </form>
          ...
          <div className="flex w-full justify-between mt-[5rem]">
            <figure className="p-[2.4rem] rounded-[2.4rem] border-2 border-greyBackGround">
              <img
      ...
      <div className="copyRight  bg-white shadow-lg">
        <div className="container mx-auto mt-[5rem] py-[5rem] px-[7rem] max-w-[1300px] flex justify-between">
