...
function reducer(state, action) {
  switch (action.type) {
    ...
    case "setStayDuration":
      return { ...state, stayDuration: action.payload };
    default:
      return { ...state };
  }
}
function TourFormHome() {
  const [{ origin, hotel, arrivalDate, stayDuration }, dispatch] = useReducer(
    reducer,
    initialState
  );
