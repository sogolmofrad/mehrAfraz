        ...
        <div className="w-[40%]">
          ...
          <form className="my-[2.8rem] flex flex-col gap-[2.8rem]">
            ...
            <div className="flex flex-col gap-[2.8rem]">
              <button
                type="submit"
                className="w-full bg-mainPrimary text-white py-[1rem] px-[2rem] text-center rounded-[3.2rem] text-[1.6rem] hover:bg-mainSecondary"
              >
                ورود
              </button>
              <button
                className="w-full text-gray_7 text-center text-[1.6rem] hover:text-mainPrimary"
                onClick={onRegister}
              >
                ثبت نام
              </button>
