  ...
  return (
    <div className="bg-white p-[1.4rem]  rounded-[3.2rem]">
      ...
      <div className="flex justify-between  mt-[2rem]">
        ...
        <button className="text-mainPrimary  text-[1.4rem] flex px-[1rem] py-[5px] rounded-[2.4rem] hover:bg-pinkExtraLight hover:text-mainSecondary active:border-2 active:border-pinkLight active:text-redPrimar active:bg-white">
